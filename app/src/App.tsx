  ...
  return (
    <div className="min-h-screen bg-zinc-950 overflow-x-hidden">
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 flex items-center gap-2 bg-[#25D366] hover:bg-[#20c45e] text-white font-semibold px-4 py-3 rounded-full shadow-lg shadow-green-500/30 transition-all duration-300 hover:scale-105"
        aria-label={t.nav.cta}
      >
        <MessageCircle className="w-5 h-5 fill-white stroke-none" />
        <span className="text-sm hidden sm:inline">{t.nav.cta.replace('💬 ', '')}</span>
